    ...
    .controller("pmtctCtrl",function ($rootScope,$scope,$http,$location,$timeout,olData,olHelpers,shared) {
        $scope.lastCard = function () {
            ...
            $.post(base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if ($scope.selectedOrgUnit == "m0frOspS7JY") {
                    $scope.url="https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=dx:EZQIyBHGU2T;OOV4qrxoS2K;gN4pFrafOXL;A4hY1vHZS5b;ZBAEsBgVrBd;FLxWc7y0Q4I;aNQkSStG64V;czV0Bdb4OMs;Ejy66fSepec;ZOkuTkxNEbO&dimension=ou:LEVEL-2;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                } else {
                    $scope.url="https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=dx:EZQIyBHGU2T;OOV4qrxoS2K;gN4pFrafOXL;A4hY1vHZS5b;ZBAEsBgVrBd;FLxWc7y0Q4I;aNQkSStG64V;czV0Bdb4OMs;Ejy66fSepec;ZOkuTkxNEbO&dimension=ou:LEVEL-3;"+ $scope.selectedOrgUnit +"&filter=pe:" + $scope.selectedPeriod + "&displayProperty=NAME";
                }
        ...
        $scope.downloadExcelTotal = function(){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
                    var lastUrl="https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=dx:EZQIyBHGU2T;OOV4qrxoS2K;gN4pFrafOXL;A4hY1vHZS5b;ZBAEsBgVrBd;FLxWc7y0Q4I;aNQkSStG64V;czV0Bdb4OMs;Ejy66fSepec;ZOkuTkxNEbO&dimension=ou:LEVEL-2;m0frOspS7JY&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&tableLayout=true&columns=dx&rows=ou";
                    ...
                    var lastUrl="https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=dx:EZQIyBHGU2T;OOV4qrxoS2K;gN4pFrafOXL;A4hY1vHZS5b;ZBAEsBgVrBd;FLxWc7y0Q4I;aNQkSStG64V;czV0Bdb4OMs;Ejy66fSepec;ZOkuTkxNEbO&dimension=ou:LEVEL-3;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&tableLayout=true&columns=dx&rows=ou"
