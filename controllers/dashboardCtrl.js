...
angular.module("hmisPortal")
    ...
    .controller("dashboardCtrl",function ($rootScope,$scope,$http,$location,$timeout,olData,olHelpers,shared,portalService) {
        ...
        $scope.baseUrl  = "https://hmisportal.moh.go.tz/dhis/";;
        ...
        $scope.downloadExcel1 = function(){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
                    url = "https://hmisportal.moh.go.tz/dhis/api/analytics.csv?dimension=dx:ykShMtNgDB1&dimension=Cow9nZikDgD:LBipXEMD6mq;FfN1mqXvpR7;aZcKJ9XxvaF;HKU7NijIEIH;h8JRv8POdfy&dimension=ou:LEVEL-2;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&outputIdScheme=NAME";
                }else{
                    url = "https://hmisportal.moh.go.tz/dhis/api/analytics.csv?dimension=dx:ykShMtNgDB1&dimension=Cow9nZikDgD:LBipXEMD6mq;FfN1mqXvpR7;aZcKJ9XxvaF;HKU7NijIEIH;h8JRv8POdfy&dimension=ou:LEVEL-3;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME&outputIdScheme=NAME";
                }
        ...
        $scope.downloadPopulationExcel = function(card){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
//                    https://hmisportal.moh.go.tz/dhis/api/analytics.csv?dimension=dx:ykShMtNgDB1&dimension=pe:2014&dimension=ou:LEVEL-2;m0frOspS7JY&displayProperty=NAME&outputIdScheme=NAME
        ...
        $scope.prepareSeries = function(){
            ...
            $.post( base + "dhis-web-commons-security/login.action?authOnly=true", {
                ...
                if($scope.selectedOrgUnit == "m0frOspS7JY"){
                    ...
                    $scope.url = "https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=Cow9nZikDgD:LBipXEMD6mq;FfN1mqXvpR7;aZcKJ9XxvaF;HKU7NijIEIH;h8JRv8POdfy&dimension=dx:ykShMtNgDB1&dimension=ou:LEVEL-2;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME";
                }else{
                    $scope.url = "https://hmisportal.moh.go.tz/dhis/api/analytics.json?dimension=Cow9nZikDgD:LBipXEMD6mq;FfN1mqXvpR7;aZcKJ9XxvaF;HKU7NijIEIH;h8JRv8POdfy&dimension=dx:ykShMtNgDB1&dimension=ou:LEVEL-3;"+$scope.selectedOrgUnit+"&filter=pe:"+$scope.selectedPeriod+"&displayProperty=NAME";
                }
